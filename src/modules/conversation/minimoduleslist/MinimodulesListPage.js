...
var MinimodulesListController = require('./MinimodulesListController.js');
...
var MinimodulesListPage = React.createClass({
	mixins: [Subscribable.Mixin],
	componentWillMount: function() {
		MinimodulesListController.getData();
	},
	...
	getInitialState: function() {
		MinimodulesListController.setViewController(this);
...
module.exports = MinimodulesListPage;